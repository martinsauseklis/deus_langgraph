...
from agent.utils.nodes.business_analyst_node.tools_node import business_analyst_tools_node
...
from agent.utils.routers.business_analyst_router import business_analyst_router
...
workflow.add_node("business_analyst_tools", business_analyst_tools_node)
...
workflow.add_conditional_edges(
    "developer_node",
    tools_condition,
    {"tools": "developer_tools", "__end__": END},
)
workflow.add_conditional_edges(
...
workflow.add_conditional_edges(
    "testing_node",
    tools_condition,
    {"tools": "testing_tools", "__end__": END},
)
workflow.add_conditional_edges(
...
workflow.add_edge("input_validation_node", "business_analyst_node")
